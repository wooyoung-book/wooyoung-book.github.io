        ...
        return links.map(link => `
            <div style="margin-bottom: 2px;">
                <a href="#" 
                   ...
                   style="color: black; text-decoration: none; background-color: #FFFEBD; padding: 0px; border-radius: 5px; display: inline-block; transition: background-color 0.3s ease;">
                    ${link.label}
                </a>
            </div>
        `).join('');
